...
function Footer() {
    ...
    const btn_click = () => {
        if (Email_input == "" || Email_input == undefined) {
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="w-100">
                            <div class="input-group">
                                <input type="text" onChange={(e) => setEmail(e.target.value)} class="form-control border-light"  placeholder="Your Email Address"/><button onClick={() => btn_click()} class="btn btn-primary px-4">Sign Up</button>
                            </div>
                        </div>
                    </div>
                </div>
