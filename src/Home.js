...
function Home() {
  ...
  return (
    ...
    <div class="container-fluid bg-light py-6 px-5">
        <div class="text-center mx-auto mb-5" >
            <h1 className="project" class="display-5 text-uppercase mb-4">Some Of Our <span class="text-primary">Popular</span> Dream Projects</h1>
        </div>
        <div class="row gx-5">
                ...
                <div class="d-inline-block bg-dark-radial text-center pt-4 px-5 mb-5">
                    <ul class="list-inline mb-0" id="portfolio-flters">
                        <li class="btn btn-outline-primary bg-white p-2 active mx-2 mb-4" data-filter="*">
                            <img src="img/portfolio-1.jpg" className="pot2" />
                            <div class="position-absolute top-0 start-0 end-0 bottom-0 m-2 d-flex align-items-center justify-content-center" className="pot3" >
                                <h6 class="text-white text-uppercase m-0">All</h6>
                            </div>
                        </li>
                        <li class="btn btn-outline-primary bg-white p-2 mx-2 mb-4" data-filter=".first">
                            <img src="img/portfolio-2.jpg" className="pot2" />
                            <div class="position-absolute top-0 start-0 end-0 bottom-0 m-2 d-flex align-items-center justify-content-center" className="pot3" >
                        ...
                        <li class="btn btn-outline-primary bg-white p-2 mx-2 mb-4" data-filter=".second">
                            <img src="img/portfolio-3.jpg" className="pot2" />
                            <div class="position-absolute top-0 start-0 end-0 bottom-0 m-2 d-flex align-items-center justify-content-center" className="pot3" >
                ...
                <div className="row g-0">
                    <div className="col-10"  >
                        <div className="position-relative h-100" >
                            <img className="position-absolute w-100 h-100" src="img/team-1.jpg" />
                        </div>
                    </div>
                    <div class="col-2">
    ...
    <div class="container-fluid bg-light py-6 px-5">
        <div class="text-center mx-auto mb-5" className="pot1">
